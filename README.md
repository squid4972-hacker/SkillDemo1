...
Data can be added to Tester File to test program using a driver program. Based on given information, the program will
calculate the total rental sales and find a reservation if it exists and print the rental car information for that reservation.
